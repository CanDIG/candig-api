...
from beacon.omop import analyses, biosamples, cohorts, datasets, g_variants, individuals, runs, filtering_terms
...
routes = [
    ...
    # web.get('/api/filtering_terms/', framework.filtering_terms), # Need to write the filtering terms from the db
